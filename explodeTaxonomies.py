...
directory = '/Users/michelle/Documents/GitHub/levy-api/aggregated/'
if not os.path.exists(directory):
    os.mkdir(directory)

df = pd.read_csv(filename, header=0)
fields = ['field_publisher', 'field_subjects', 'lyricist', 'composer',
          'arranger', 'no_role', 'pseudonym', 'field_instrumentation_metadata']
id = 'fileIdentifier'
